...
Für die meisten ist es schlicht umständlich ihr Gehalt in Euro zu erhalten, sich um einen Teil davon Bitcoins zu kaufen, diese bei einem Shop auszugeben, wo sie auch mit Euros hätten bezahlen können und welcher diese Bitcoins danach ebenfalls wieder zurück in Euros tauschen wird.
...
\emph{Segrageted Witness} schlägt vor, die eigentlich Transaktion (Inputs, Outputs und Beträge) von dem Teil zu trennen der nur für die Verifikation von Relevanz ist (v.a. Signatur) und diesen Teil nur solange zu speichern, solange er benötigt wird und ihn daher nicht in die Blockchain aufnehmen.
