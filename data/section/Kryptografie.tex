...
\Cf[182]{schmeh2013}
Beispiele für solche Gruppen ist beispielsweise die Addition in den ganzen Zahlen, die Multiplikation in den reellen Zahlen, die Moduloaddition in einem beliebigen Restklassenring, sowie die Modulomultiplikation in der Menge $\{ 1, \dotsc, p \mid p \in \mathbb{P}\}$.
...
\begin{enumerate}
    ...
    Da aber nur Alice den privaten Schlüssel innehat, lässt sich somit die Authentizität der Nachricht überprüfen.
