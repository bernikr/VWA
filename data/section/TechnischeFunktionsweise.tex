...
Um Bitcoin zu versendenden, muss man also eine vorhergegangene Transaktion referenzieren, durch welche man die Bitcoins erhalten hat und anschließend die Transaktion signieren, um zu Beweisen, dass man berechtigt ist jene zu versenden.
...
Während jeder Bitcoin-Client und jeder Miner zuerst den Block verwendet, den er als erstes erhalten hat, werden sich alle Beteiligten über den nächsten Block einig, sobald ein Miner den diesen findet, egal welcher der beiden Blöcke als Ursprung dient.
